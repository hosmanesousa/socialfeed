...
<body>
 ...
 // stay on either login or register page
 ...
 ?>
  <div class = "wrapper">
    ...
    <form action="register.php" method = "POST">
       ...
       <a href ="#" id ="signup" class = "signup"><br>Need an account? Register here.</a>
    ...
    <form action = "register.php" method ="POST">
        ...
        <?php if(in_array("Your first name must be between 2 and 25 characters<br>", $error_array)) 
         ...
         <?php 
             ...
             if(in_array("Email Invalid format<br>", $error_array)) 
        ...
        ?>
         ...
         <?php 
             ...
             if(in_array("Your password can only contain numbers or English characters<br>", $error_array)) 
                echo "Your password can only contain numbers or English characters<br>";
         else 
             if(in_array("Password must be between 5 and 30 characters<br>", $error_array)) 
                echo "Password must be between 5 and 30 characters<br>"
        ?>
         <input type="submit" name ="register_button" value ="Register">

         <?php if(in_array("<span style = 'color:#14C800;'> Your are registered!! Ready to log in </span><br>", $error_array)) 
                 echo "<span style = 'color:#14C800;'> Ready to log in </span><br>";?>
